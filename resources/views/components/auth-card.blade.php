...
<div class="flex min-h-screen bg-white">
        ...
        <div class="w-full max-w-sm mx-auto lg:w-96">
            <div class="text-center">
                <div class="inline-block max-w-[160px] mx-auto">
                    <img class="w-auto h-12 mx-auto" src="{{ url('img/dts/logo.png') }}" alt="Logo" />
                    {{-- <img class="w-16 h-16" src="{{ asset(env('APP_LOGO')) }}" alt="Company Logo"> --}}
                </div>
            </div>
            <div class="mb-10 text-center">
                <div class="inline-block max-w-[300px] mx-auto">
                    <span class="font-sans text-2xl font-bold">{{ 'eDMS' }}</span><br>
    ...
    <div class="relative flex-1 hidden w-0 lg:block">
        ...
        src="{{ url('img/dts/bg.png') }}" alt="Company office" />
    </div>
</div>
